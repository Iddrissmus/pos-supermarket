...
<head>
    ...
    <title>Business Admin Login - POS Supermarket</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-bold text-gray-900">Business Admin Login</h2>
            </div>
            ...
            <form method="POST" action="{{ route('login.business-admin.post') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" 
                               ...
                               id="email"
                               value="{{ old('email') }}"
                               class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-sm @error('email') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                               placeholder="businessadmin@pos.com"
                               required 
                               autofocus>
                    </div>
                    @error('email') 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" 
                               name="password"
                               id="password"
                               class="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-sm @error('password') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                               placeholder="••••••••"
                               required>
                        <button type="button" 
                ...
                <!-- Submit Button -->
                <button type="submit" 
                        class="w-full bg-blue-600 text-white py-2.5 rounded-lg font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all shadow-sm hover:shadow flex items-center justify-center space-x-2">
                    <span>Sign In</span>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100">
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <a href="{{ route('login.cashier') }}" class="flex flex-col items-center justify-center p-3 rounded-lg border border-gray-200 hover:border-orange-500 hover:bg-orange-50 transition-all group">
                        <i class="fas fa-cash-register text-orange-500 mb-1.5 text-lg group-hover:scale-110 transition-transform"></i>
                        <span class="text-[10px] font-medium text-gray-600 group-hover:text-orange-700">Cashier</span>
                    </a>
                </div>
            </div>
        </div>
