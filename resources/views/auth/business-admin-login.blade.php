...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <!-- Back to Home -->
        <div class="mb-4">
            <a href="/" class="text-white hover:text-blue-200 transition-colors inline-flex items-center space-x-2">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div class="text-center mb-8">
                <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-700 rounded-full mb-4">
                    <i class="fas fa-briefcase text-white text-2xl"></i>
                </div>
                <h2 class="text-3xl font-bold text-gray-800 mb-2">Business Admin Login</h2>
                <p class="text-gray-600">Business Management Access</p>
            </div>
            ...
            <form method="POST" action="{{ route('login.business-admin.post') }}" class="space-y-6">
                @csrf
                ...
                <!-- Submit Button -->
                <button type="submit" 
                        class="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-blue-800 transform hover:scale-[1.02] transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2">
                    <span>Sign In</span>
