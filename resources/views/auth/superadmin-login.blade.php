    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-bold text-gray-900">SuperAdmin Login</h2>
            </div>
            ...
            <form method="POST" action="{{ route('login.superadmin.post') }}" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" 
                               ...
                               id="email"
                               value="{{ old('email') }}"
                               class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors text-sm @error('email') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" 
                               name="password"
                               id="password"
                               class="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors text-sm @error('password') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" 
                               placeholder="••••••••"
                               required>
                        <button type="button" 
                ...
                <!-- Submit Button -->
                <button type="submit" 
                        class="w-full bg-purple-600 text-white py-2.5 rounded-lg font-medium hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all shadow-sm hover:shadow flex items-center justify-center space-x-2">
                    <span>Sign In</span>
