...
<div class="p-6 space-y-6">
    ...
    <div class="bg-white shadow rounded-lg p-6">
        ...
        <form method="POST" action="{{ route('manager.cashiers.create') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <div class="flex items-center justify-between mb-1">
                        ...
                        <button type="button" 
                                onclick="generateManagerPassword()"
                    ...
                    <div class="relative">
                        ...
                        <button type="button"
                                onclick="toggleManagerPassword('password', 'eye-pass')"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button"
                                onclick="toggleManagerPassword('password_confirmation', 'eye-conf')"
                                class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700">
            ...
            <div id="manager-password-alert" class="hidden bg-green-50 border border-green-200 rounded-lg p-3">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <p class="text-xs text-green-700 font-medium mb-1">Generated Password:</p>
                        <code id="manager-password-display" class="text-sm text-green-900 font-mono break-all"></code>
                    </div>
                    <button type="button"
                            onclick="copyManagerPassword()"
                ...
                <p class="text-xs text-green-600 mt-2">
                    <i class="fas fa-info-circle mr-1"></i>Save this password - the cashier will need it to log in!
                </p>
            </div>
...
function generateManagerPassword() {
    ...
    document.getElementById('eye-conf').classList.remove('fa-eye');
    document.getElementById('eye-conf').classList.add('fa-eye-slash');
}
