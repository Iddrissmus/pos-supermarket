...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <p class="text-gray-600">This is your owner dashboard. You can manage your businesses, branches, and view performance metrics.</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md mb-8">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Your Businesses</h2>
        </div>
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="border rounded-lg p-4">
                    ...
                    <p class="text-sm text-gray-600 mb-2">{{ $business->description ?? 'No description' }}</p>
                    <div class="flex justify-between text-sm text-gray-500">
                        <span>{{ $business->branches->count() }} branches</span>
