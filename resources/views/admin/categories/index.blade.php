            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($categories as $category)
                        <tr class="hover:bg-gray-50 cursor-pointer" onclick="toggleSubcategories({{ $category->id }})">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    <button type="button" class="text-gray-400 hover:text-gray-600 focus:outline-none" onclick="event.stopPropagation(); toggleSubcategories({{ $category->id }})">
                                        <i class="fas fa-chevron-right transition-transform duration-200" id="icon-category-{{ $category->id }}"></i>
                                    </button>
                        ...
                        @if($category->subcategories->count() > 0)
                            <tr id="subcategories-{{ $category->id }}" class="hidden">
                                <td colspan="6" class="px-6 py-0">
                                    <div class="bg-gray-50 border-l-4 border-blue-500 pl-4 py-2">
                                        <table class="min-w-full divide-y divide-gray-200">
...
function toggleSubcategories(categoryId) {
    const subcategoriesRow = document.getElementById('subcategories-' + categoryId);
